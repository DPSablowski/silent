...
#ifndef UI_CLASSICAL_H
#define UI_CLASSICAL_H
...
public:
    ...
    void setupUi(QDialog *classical)
    {
        ...
        gridLayout = new QGridLayout(classical);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        scrollArea = new QScrollArea(classical);
        ...
        horizontalLayout->addWidget(doubleSpinBox_17);
        ...
        doubleSpinBox_18->setMaximum(90);

        horizontalLayout_3->addWidget(doubleSpinBox_18);
        ...
        horizontalLayout_31->addWidget(doubleSpinBox_12);
        ...
        doubleSpinBox_19->setMinimum(-90);
        doubleSpinBox_19->setMaximum(90);

        horizontalLayout_4->addWidget(doubleSpinBox_19);
        ...
        sizePolicy.setHeightForWidth(doubleSpinBox_20->sizePolicy().hasHeightForWidth());
        doubleSpinBox_20->setSizePolicy(sizePolicy);
        doubleSpinBox_20->setMaximum(9999.99);

        horizontalLayout_5->addWidget(doubleSpinBox_20);
        ...
        sizePolicy.setHeightForWidth(doubleSpinBox_21->sizePolicy().hasHeightForWidth());
        doubleSpinBox_21->setSizePolicy(sizePolicy);
        doubleSpinBox_21->setMaximum(9999.99);

        horizontalLayout_6->addWidget(doubleSpinBox_21);
        ...
        sizePolicy.setHeightForWidth(doubleSpinBox_22->sizePolicy().hasHeightForWidth());
        doubleSpinBox_22->setSizePolicy(sizePolicy);
        doubleSpinBox_22->setDecimals(4);
        doubleSpinBox_22->setMaximum(9.99);

        horizontalLayout_8->addWidget(doubleSpinBox_22);
        ...
        sizePolicy.setHeightForWidth(doubleSpinBox_23->sizePolicy().hasHeightForWidth());
        doubleSpinBox_23->setSizePolicy(sizePolicy);
        doubleSpinBox_23->setDecimals(4);
        doubleSpinBox_23->setMaximum(9.99);

        horizontalLayout_8->addWidget(doubleSpinBox_23);
        ...
        horizontalLayout_25->addWidget(pushButton_3);
        ...
        horizontalLayout_38->addLayout(verticalLayout);
        ...
        horizontalLayout_38->addWidget(line);
        ...
        doubleSpinBox_14->setMaximum(99999);
        ...
        doubleSpinBox_15->setMaximum(9999);

        horizontalLayout_12->addWidget(doubleSpinBox_15);
        ...
        horizontalLayout_15->addWidget(doubleSpinBox);
        ...
        horizontalLayout_18->addWidget(spinBox);
        ...
        horizontalLayout_20->addWidget(doubleSpinBox_2);
        ...
        horizontalLayout_21->addWidget(doubleSpinBox_3);
        ...
        horizontalLayout_24->addWidget(doubleSpinBox_6);
        ...
        doubleSpinBox_5->setValue(0.85);

        horizontalLayout_23->addWidget(doubleSpinBox_5);
        ...
        horizontalLayout_38->addLayout(verticalLayout_2);
        ...
        horizontalLayout_38->addWidget(line_4);
        ...
        horizontalLayout_29->addWidget(doubleSpinBox_10);
        ...
        doubleSpinBox_16->setMaximum(9999);

        horizontalLayout_32->addWidget(doubleSpinBox_16);
        ...
        horizontalLayout_34->addWidget(spinBox_6);
        ...
        horizontalLayout_35->addWidget(spinBox_7);
        ...
        horizontalLayout_36->addWidget(spinBox_8);
        ...
        horizontalLayout_37->addWidget(spinBox_9);
        ...
        horizontalLayout_39->addWidget(lineEdit);

        label_11 = new QLabel(scrollAreaWidgetContents);
        label_11->setObjectName(QStringLiteral("label_11"));

        horizontalLayout_39->addWidget(label_11);
        ...
        horizontalLayout_39->addWidget(pushButton_5);
        ...
        horizontalLayout_40->addWidget(lineEdit_2);

        label_41 = new QLabel(scrollAreaWidgetContents);
        label_41->setObjectName(QStringLiteral("label_41"));

        horizontalLayout_40->addWidget(label_41);
        ...
        horizontalLayout_40->addWidget(pushButton_6);
        ...
        horizontalLayout_38->addLayout(verticalLayout_3);
        ...
        retranslateUi(classical);
        QObject::connect(pushButton, SIGNAL(clicked()), classical, SLOT(close()));

        QMetaObject::connectSlotsByName(classical);
    } // setupUi
...
namespace Ui {
    class classical: public Ui_classical {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CLASSICAL_H
